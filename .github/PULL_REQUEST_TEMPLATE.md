...
- New plugin integration should be added in alphabetical order:
  - to the [README](https://github.com/ferra/nvim#integrations) (vimdoc is auto-generated).
  - to [types.lua](https://github.com/ferra/nvim/blob/main/lua/ferra/types.lua)
...
Here are some tips:
- Use `vim.g.ferra_debug = true` to get live config re-loading
