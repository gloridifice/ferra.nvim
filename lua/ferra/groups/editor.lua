...
function M.get()
	...
	return {
		...
		CursorLine = {
			bg = U.darken(C.surface0, 0.64, C.base),
		...
		Folded = { fg = C.coral, bg = O.transparent_background and C.none or C.surface1 }, -- line used for closed folds
		...
		FloatBorder = O.float.solid
			...
			or { fg = C.coral, bg = (O.float.transparent and vim.o.winblend == 0) and C.none or C.mantle },
		...
		PmenuBorder = {
			bg = (O.transparent_background and vim.o.pumblend == 0) and C.none or C.mantle,
			fg = pumsolid and ((O.transparent_background and vim.o.pumblend == 0) and C.none or C.mantle) or C.coral,
		}, -- Popup menu: border
